...
const forgotPassword = async (req, res, next) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `
            <h1 style='color: #198754; font-weight: bold;'>BloggingApp</h1>
            <h2 style='font-weight: bold;'>Reset password</h2>
            <p>Please click on the link below to reset your account password:</p>
            <a href='http://localhost:3000/password/reset-password-page/${requestId}' style='color: #198754; font-weight: bold;'>Reset password</a>`
        };
